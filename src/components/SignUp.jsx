            ...
            <div className="main1">
                <div className="signup-container">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <input type="text" className="signup-form-control" placeholder="insert role" name="role" onChange={handleChange} />
                            {/* /{formErrors.confirmPassword && <div className="signup-alert alert-danger mt-3">{formErrors.role}</div>} */}
                        </div>
