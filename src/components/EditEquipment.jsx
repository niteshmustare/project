...
console.log(formData);
    ...
    />
                    ...
                    <Col lg={4}>
                            <Form.Group className="mb-3">
                                <Form.Label>last maintained On Date</Form.Label>
                                <Form.Control
                                    type="date"
                                    value={formatDateForInput(formData.maintainedOnDate)}
                                    name="maintainedOnDate"
                                    onChange={handleChange}
                                />
                            </Form.Group>
                        </Col>
                ...
                <Row className="mt-3">
                    <Col lg={4}>
                        {isSubmitted ? <Alert variant="success">Equipment Details updated</Alert> : null}
                    </Col>
                </Row>
                </div>
            </Container>
