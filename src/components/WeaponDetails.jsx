...
export function WeaponDetails() {
  ...
  const handleEquipmentDelete = async () => {
    try {
     const result = await deleteEquipment(selectedEquipment);
...
<div className="detail">
        ...
        <div className="details-grid">
          ...
          <div className="detail-item">
            <span className="detail-label">last maintained On Date:</span>
            <span>{formatDate(weapon.maintainedOnDate)}</span>
          </div>
          <div className="detail-item">
